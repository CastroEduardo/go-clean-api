...
curl -X 'POST' \
  'http://192.168.70.101:9003/api/v1/users/login-by-username' \
  -H 'accept: application/json' \
  -H 'Content-Type: application/json' \
  -d '{
  "password": "12345678",
...
curl -X 'POST' \
  'http://localhost:9002/api/v1/users/register-by-username' \
  -H 'accept: application/json' \
  -H 'Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJFbWFpbCI6ImFkbWluQGFkbWluLmNvbSIsIkV4cCI6MTc2MjQ4ODU1OCwiRmlyc3ROYW1lIjoiVGVzdCIsIkxhc3ROYW1lIjoiVGVzdCIsIk1vYmlsZU51bWJlciI6IjA5MTExMTEyMjIyIiwiUm9sZXMiOm51bGwsIlVzZXJJZCI6MSwiVXNlcm5hbWUiOiIifQ.0OxQYJU-T_HbzWjnF5wNY2-hK0nFOsD3pvdLtD1lKWI' \
  -H 'Content-Type: application/json' \
  -d '{
...
eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJFbWFpbCI6ImFkbWluQGFkbWluLmNvbSIsIkV4cCI6MTc2MjQ4Mjc2NSwiRmlyc3ROYW1lIjoiVGVzdCIsIkxhc3ROYW1lIjoiVGVzdCIsIk1vYmlsZU51bWJlciI6IjA5MTExMTEyMjIyIiwiUm9sZXMiOm51bGwsIlVzZXJJZCI6MSwiVXNlcm5hbWUiOiIifQ.3Nj2YUQX8F8B99vbHbTG8RQImzqndzdI_tNm5SILFnw
